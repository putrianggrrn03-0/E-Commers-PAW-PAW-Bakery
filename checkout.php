...
<body>
        ...
        ORDER BY k.id_keranjang DESC";
                ...
                <div class="order-summary">
                    <div class="order-item">
                        <img src="img/<?php echo $row['gambar'] ?>" alt="Brownie">
                        <div class="order-text">
                            <strong><?php echo $row['nama_produk'] ?> </strong> • x<?php echo $row['quantity'] ?><br>
                        </div>
                    </div>
                    <div><strong>Rp <?php echo number_format($row['total_price_item'], 0, ',', '.') ?></strong></div>
                </div>
    <?php
                    }
                }
    ?>
        ...
        <!-- Button -->
        <button class="btn" type="submit" name="pay_now">Pay Now</button>
